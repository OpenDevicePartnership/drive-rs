...
{% if wants_sync %}impl<I2C: embedded_hal::i2c::I2c> device_driver::RegisterInterface for I2cInterface<I2C> {
    fn write_register(
        &mut self,
        address: u8,
        data: &mut [u8],
...
impl<SPI: embedded_hal::spi::ErrorType> device_driver::RegisterInterfaceBase
...
impl<UART: embedded_io::ErrorType> device_driver::BufferInterfaceBase for UartInterface<UART> {
